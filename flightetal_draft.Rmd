...
with `r I(sum(tmVmm["tm"] >= tmVmm["mm"]))` of the `r I(lenth(isExon))` showing higher correlation in the TMmm assignments calculated in `r I(pasteLabel("Table", tableCount, "t.corrTable"))`.
