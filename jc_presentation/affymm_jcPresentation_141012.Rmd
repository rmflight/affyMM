...
```{r insertSequence, comment="", echo=FALSE}
outSeq
```
...
print(tmpCor, type='html', html.table.attributes = 'style="font-size:50%; text-align:left; td.padding: 0.5em;"', include.rownames=FALSE)
```
...
print(xtable(hData), type='html', html.table.attributes = 'style="text-align:left"', include.rownames=FALSE)
```
...
print(xtable(probeCounts), type='html', include.rownames=FALSE)
```
